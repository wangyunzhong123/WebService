...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements weather.HelloWorldService {
    ...
    public weather.HelloWorld_PortType getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    public weather.HelloWorld_PortType getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            weather.HelloWorldSoapBindingStub _stub = new weather.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (weather.HelloWorld_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                weather.HelloWorldSoapBindingStub _stub = new weather.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
